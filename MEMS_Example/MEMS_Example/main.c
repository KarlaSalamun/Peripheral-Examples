...
{   
  ...
  if ( Xval>Yval)
  {
    if ((int16_t)Buffer[0] > 40)
    {
      ...
      LCD_DisplayStringLine(LINE(1), (uint8_t*)"Gore");
      Delay(50);
    }
    if ((int16_t)Buffer[0] < -40)
    {
      ...
      LCD_SetTextColor(LCD_COLOR_BLUE);
      LCD_SetFont(&Font16x24);
      LCD_DisplayStringLine(LINE(1), (uint8_t*)"Dolje");
      Delay(50);
    }
  }
  else
  {
    if ((int16_t)Buffer[1] < -40)
    {
      ...
      LCD_SetTextColor(LCD_COLOR_BLUE);
      LCD_SetFont(&Font16x24);
      LCD_DisplayStringLine(LINE(1), (uint8_t*)"Lijevo");     
      Delay(50);
    }
    if ((int16_t)Buffer[1] > 40)
    {      
      ...
      LCD_SetTextColor(LCD_COLOR_BLUE);
      LCD_SetFont(&Font16x24);
      LCD_DisplayStringLine(LINE(1), (uint8_t*)"Desno");
      Delay(50);
    } 
  } 
}
